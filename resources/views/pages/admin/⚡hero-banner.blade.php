...
new class extends Component
{
    ...
    public function store()
    {
        ...
        // Reset form
        $this->reset(['title', 'subtitle', 'cta_text', 'image']);

        session()->flash('success', 'Hero banner berhasil dibuat!');
    }
...
<div class="font-inter max-w-3xl">
    ...
    {{-- Flash Message --}}
    @if (session('success'))
        <div class="mb-6 flex items-center gap-3 px-4 py-3 rounded-xl bg-green-500/10 border border-green-500/20 text-green-400 text-sm font-medium">
            <svg xmlns="http://www.w3.org/2000/svg" class="size-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
    ...
    <div class="bg-gray-800/50 border border-white/10 rounded-2xl overflow-hidden">
        ...
        <div class="px-6 py-4 border-b border-white/10 flex items-center gap-3">
            <div class="size-8 rounded-lg bg-yellow-500/10 border border-yellow-500/20 flex items-center justify-center shrink-0">
                <svg xmlns="http://www.w3.org/2000/svg" class="size-4 text-yellow-500" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" d="m2.25 15.75 5.159-5.159a2.25 2.25 0 0 1 3.182 0l5.159 5.159m-1.5-1.5 1.409-1.409a2.25 2.25 0 0 1 3.182 0l2.909 2.909m-18 3.75h16.5a1.5 1.5 0 0 0 1.5-1.5V6a1.5 1.5 0 0 0-1.5-1.5H3.75A1.5 1.5 0 0 0 2.25 6v12a1.5 1.5 0 0 0 1.5 1.5Zm10.5-11.25h.008v.008h-.008V8.25Zm.375 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Z" />
                </svg>
            </div>
            <div>
                <h2 class="text-sm font-semibold text-white">Tambah Banner Baru</h2>
                <p class="text-xs text-gray-500">Isi semua field yang diperlukan</p>
            </div>
        </div>
        ...
        <form wire:submit="store">
            ...
            <div class="px-6 py-5 border-b border-white/10">
                <div class="flex flex-col sm:flex-row sm:items-start gap-4">
                    ...
                    <div class="sm:w-2/3">
                        <input wire:model="title" type="text" id="title" placeholder="Contoh: New Arrival — Summer Collection"
                        ...
                        @error('title')
                            <p class="mt-1.5 text-xs text-yellow-400 flex items-center gap-1">
                                <svg xmlns="http://www.w3.org/2000/svg" class="size-3.5" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3.75m9-.75a9 9 0 1 1-18 0 9 9 0 0 1 18 0Zm-9 3.75h.008v.008H12v-.008Z"/></svg>
                                {{ $message }}
                            </p>
                        @enderror
                    </div>
            ...
            <div class="px-6 py-5 border-b border-white/10">
                <div class="flex flex-col sm:flex-row sm:items-start gap-4">
                    ...
                    <div class="sm:w-2/3">
                        <textarea wire:model="subtitle" id="subtitle" rows="3" placeholder="Contoh: Flexi Fit — Anti Kusut, flexible, cool"
                ...
                <div class="flex flex-col sm:flex-row sm:items-start gap-4">
                    ...
                    <div class="sm:w-2/3">
                        ...
                        <label for="image"
                            ...
                            @if ($image)
                                <img src="{{ $image->temporaryUrl() }}" class="h-full w-full object-cover rounded-xl" alt="Preview">
                            @else
                                <div class="flex flex-col items-center gap-2 text-gray-500 group-hover:text-yellow-500 transition">
                        ...
                        {{-- Loading indicator --}}
                        <div wire:loading wire:target="image" class="mt-2 flex items-center gap-2 text-xs text-gray-400">
                            <svg class="animate-spin size-4 text-yellow-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
            ...
            <div class="px-6 py-5 border-b border-white/10">
                <div class="flex flex-col sm:flex-row sm:items-start gap-4">
                    ...
                    <div class="sm:w-2/3">
                        <input wire:model="cta_text" type="text" id="cta_text" placeholder="Contoh: Harus punya!"
                            class="block w-full rounded-xl border border-white/10 bg-gray-900/60 px-4 py-2.5 text-sm text-white placeholder-gray-600 focus:outline-none focus:border-yellow-500 focus:ring-1 focus:ring-yellow-500 transition">
                        @error('cta_text')
                            <p class="mt-1.5 text-xs text-yellow-400 flex items-center gap-1">
                                <svg xmlns="http://www.w3.org/2000/svg" class="size-3.5" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3.75m9-.75a9 9 0 1 1-18 0 9 9 0 0 1 18 0Zm-9 3.75h.008v.008H12v-.008Z"/></svg>
            ...
            <div class="px-6 py-4 bg-gray-900/30 flex items-center justify-between">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <button type="submit"
                        class="inline-flex items-center gap-2 px-5 py-2 text-sm font-semibold rounded-xl text-black bg-yellow-500 hover:bg-yellow-400 focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:ring-offset-2 focus:ring-offset-gray-900 transition">
                        <span wire:loading.remove wire:target="store">
                            <svg xmlns="http://www.w3.org/2000/svg" class="size-4 inline -mt-0.5" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
